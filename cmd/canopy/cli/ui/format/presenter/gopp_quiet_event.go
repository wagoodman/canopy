...
func NewGoPPQuietEventFactory(sty style.Go, i ide.Context, packageNameWidth int) GoPPQuietEventFactory {
	return GoPPQuietEventFactory{
		Style:            sty,
		IDE:              i,
...
func (f GoPPQuietEventFactory) NewEvent(e gotest.Event, midPanic bool) fmt.Stringer {
	return GoPPQuietEvent{
		Style:            f.Style,
		IDE:              f.IDE,
...
func (p GoPPQuietEvent) String() string {
	e := p.Event
...
func (p GoPPQuietEvent) formatPackage(e gotest.Event) string {
